...
class Treinos():
    ...
    def Modalidades(self):
        ...
        plano_label = ctk.CTkLabel(frame_superior, text=f"Plano Intermediário, Olá {self.nome_usuario.lower().capitalize()}", text_color="white", fg_color="#5ce1e6", font=("Arial", 18, 'bold'))
