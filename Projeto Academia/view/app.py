...
from view.treinos import Treinos
...
# Janelas
    ...
    def Home(self):
        ...
        btn_treinos = ctk.CTkButton(central_frame, text="Treinos", fg_color="#808080", hover_color="#A9A9A9", command=Treinos.treinos, font=("Arial", 18, "bold"), width=150, height=50)
