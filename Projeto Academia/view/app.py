...
# Janelas
    ...
    def Peito(self, pagina=1):
        ...
        for i, exercicio in enumerate(paginas[pagina]["exercicios"]):
            ...
            exercise_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
    ...
    def Costas(self):
        ...
        puxada_alta_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
        ...
        remada_curvada_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
        ...
        levantamento_terra_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
        ...
        rosca_direta_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
        ...
        rosca_martelo_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
        ...
        rosca_concentrada_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
    ...
    def Quadriceps(self):
        ...
        agachamento_smith_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
        ...
        extensao_pernas_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30, width=200, height=200)
        ...
        leg_press_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
        ...
        agachamento_frontal_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
        ...
        avancado_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
        ...
        step_up_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
    ...
    def Perna(self):
        ...
        stiff_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=15, width=200, height=200)
        ...
        afundo_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30, width=200, height=200)
        ...
        pernas_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
        ...
        sumo_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
        ...
        hip_thrust_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
        ...
        panturrilha_frame = ctk.CTkFrame(central_frame, fg_color="#5c8be6", corner_radius=30)
